...
Successfully handled a large-scale dataset of 100,000 transactions across 15 different cities.


Diverse Customer Base: 

Identified clear segments—Budget, Regular, and Premium—spanning a wide age demographic.


Operational Readiness: 

The automated cleaning process ensures that raw transaction logs are converted into a reliable format for business intelligence tools.
